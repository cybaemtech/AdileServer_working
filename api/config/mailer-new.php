...
class SimpleMailer {
    ...
    public function __construct() {
        // Configure SMTP settings - Gmail requires App Password, not regular password
        $this->smtp_host = 'smtp.gmail.com';
        $this->smtp_port = 587; // TLS port
        $this->smtp_username = 'priyanka.k@cybaemtech.com';
        $this->smtp_password = 'Cybaem@123'; // This should be a Gmail App Password
        $this->from_email = 'priyanka.k@cybaemtech.com'; // Must match SMTP username
