    ...
    try {
      ...
      if (selectedFile) {
        try {
          ...
          // Always store screenshot in binary (screenshot_blob) for database
          submitData.screenshot_blob = base64String;
          // Remove other screenshot fields to avoid confusion
          delete submitData.screenshot;
          // Store path for reference
          const timestamp = new Date().getTime();
          submitData.screenshot_path = `screenshot_${timestamp}_${selectedFile.name}`;
        } catch (error) {
